...
@function values($deps: $_default, $exclude-hardcoded-values: false) {
  @return (
    ...
    if(
        ...
        map.get($deps, 'md-sys-typescale', 'title-medium-weight') map.get($deps, 'md-sys-typescale', 'title-medium-size') #{'/'} map.get(
            $deps,
            'md-sys-typescale',
    ...
    if(
        ...
        map.get($deps, 'md-sys-typescale', 'display-medium-weight') map.get($deps, 'md-sys-typescale', 'display-medium-size') #{'/'} map.get(
            $deps,
            'md-sys-typescale',
    ...
    if(
        ...
        map.get($deps, 'md-sys-typescale', 'display-large-weight') map.get($deps, 'md-sys-typescale', 'display-large-size') #{'/'} map.get(
            $deps,
            'md-sys-typescale',
