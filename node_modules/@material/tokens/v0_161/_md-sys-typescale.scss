...
@function values($deps: $_default, $exclude-hardcoded-values: false) {
  @return (
    ...
    if(
        ...
        map.get($deps, 'md-ref-typeface', 'weight-regular') if($exclude-hardcoded-values, null, 1rem) #{'/'} if(
            $exclude-hardcoded-values,
            null,
            1.5rem
    ...
    if(
        ...
        map.get($deps, 'md-ref-typeface', 'weight-regular') if($exclude-hardcoded-values, null, 0.875rem) #{'/'} if(
            $exclude-hardcoded-values,
            null,
            1.25rem
        ) map.get($deps, 'md-ref-typeface', 'plain')
    ...
    if(
        ...
        map.get($deps, 'md-ref-typeface', 'weight-regular') if($exclude-hardcoded-values, null, 0.75rem) #{'/'} if(
            $exclude-hardcoded-values,
            null,
            1rem
        ) map.get($deps, 'md-ref-typeface', 'plain')
    ...
    if(
        ...
        map.get($deps, 'md-ref-typeface', 'weight-regular') if($exclude-hardcoded-values, null, 3.562rem) #{'/'} if(
            $exclude-hardcoded-values,
            null,
            4rem
    ...
    if(
        ...
        map.get($deps, 'md-ref-typeface', 'weight-regular') if($exclude-hardcoded-values, null, 2.812rem) #{'/'} if(
            $exclude-hardcoded-values,
            null,
            3.25rem
        ) map.get($deps, 'md-ref-typeface', 'brand')
    ...
    if(
        ...
        map.get($deps, 'md-ref-typeface', 'weight-regular') if($exclude-hardcoded-values, null, 2.25rem) #{'/'} if(
            $exclude-hardcoded-values,
            null,
            2.75rem
        ) map.get($deps, 'md-ref-typeface', 'brand')
    ...
    if(
        ...
        map.get($deps, 'md-ref-typeface', 'weight-regular') if($exclude-hardcoded-values, null, 2rem) #{'/'} if(
            $exclude-hardcoded-values,
            null,
            2.5rem
        ) map.get($deps, 'md-ref-typeface', 'brand')
    ...
    if(
        ...
        map.get($deps, 'md-ref-typeface', 'weight-regular') if($exclude-hardcoded-values, null, 1.75rem) #{'/'} if(
            $exclude-hardcoded-values,
            null,
            2.25rem
        ) map.get($deps, 'md-ref-typeface', 'brand')
    ...
    if(
        ...
        map.get($deps, 'md-ref-typeface', 'weight-regular') if($exclude-hardcoded-values, null, 1.5rem) #{'/'} if(
            $exclude-hardcoded-values,
            null,
            2rem
        ) map.get($deps, 'md-ref-typeface', 'brand')
    ...
    if(
        ...
        map.get($deps, 'md-ref-typeface', 'weight-medium') if($exclude-hardcoded-values, null, 0.875rem) #{'/'} if(
            $exclude-hardcoded-values,
            null,
            1.25rem
        ) map.get($deps, 'md-ref-typeface', 'plain')
    ...
    if(
        ...
        map.get($deps, 'md-ref-typeface', 'weight-medium') if($exclude-hardcoded-values, null, 0.75rem) #{'/'} if(
            $exclude-hardcoded-values,
            null,
            1rem
        ) map.get($deps, 'md-ref-typeface', 'plain')
    ...
    if(
        ...
        map.get($deps, 'md-ref-typeface', 'weight-medium') if($exclude-hardcoded-values, null, 0.688rem) #{'/'} if(
            $exclude-hardcoded-values,
            null,
            1rem
        ) map.get($deps, 'md-ref-typeface', 'plain')
    ...
    if(
        ...
        map.get($deps, 'md-ref-typeface', 'weight-regular') if($exclude-hardcoded-values, null, 1.375rem) #{'/'} if(
            $exclude-hardcoded-values,
            null,
            1.75rem
        ) map.get($deps, 'md-ref-typeface', 'brand')
    ...
    if(
        ...
        map.get($deps, 'md-ref-typeface', 'weight-medium') if($exclude-hardcoded-values, null, 1rem) #{'/'} if(
            $exclude-hardcoded-values,
            null,
            1.5rem
        ) map.get($deps, 'md-ref-typeface', 'plain')
