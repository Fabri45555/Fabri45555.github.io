...
export class DomRendererFactory2 {
  ...
  static {
    this.ɵfac = i0.ɵɵngDeclareFactory({
      ...
      deps: [{token: i1.EventManager}, {token: i2.SharedStylesHost}, {token: APP_ID}, {token: REMOVE_STYLES_ON_COMPONENT_DESTROY}, {token: DOCUMENT}, {token: PLATFORM_ID}, {token: i0.NgZone}, {token: CSP_NONCE}],
...
i0.ɵɵngDeclareClassMetadata({
  minVersion: "12.0.0", version: "16.2.10", ngImport: i0, type: DomRendererFactory2, decorators: [{
    ...
    return [{type: i1.EventManager}, {type: i2.SharedStylesHost}, {
