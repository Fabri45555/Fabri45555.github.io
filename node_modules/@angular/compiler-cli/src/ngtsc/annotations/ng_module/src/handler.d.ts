...
export declare class NgModuleDecoratorHandler implements DecoratorHandler<Decorator, NgModuleAnalysis, NgModuleSymbol, NgModuleResolution> {
  ...
  compileFull(node: ClassDeclaration, {
    inj,
    mod,
    fac,
    classMetadata,
  ...
  }: Readonly<NgModuleAnalysis>, {injectorImports}: Readonly<NgModuleResolution>): CompileResult[];

  compilePartial(node: ClassDeclaration, {
    inj,
    fac,
    mod,
    classMetadata
  ...
  compileLocal(node: ClassDeclaration, {
    inj,
    mod,
    fac,
    classMetadata,
