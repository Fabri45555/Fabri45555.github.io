...
@mixin color($config-or-theme) {
  ...
  $label-color: theming.get-color-from-palette($foreground, secondary-text, if($is-dark-theme, 0.7, 0.6));
  ...
  // Underline colors.
  $underline-color-base: theming.get-color-from-palette($foreground, divider, if($is-dark-theme, 1, 0.87));
