...
@mixin outline-color($config-or-theme) {
  ...
  $outline-color: theming.get-color-from-palette($foreground, divider, if($is-dark-theme, 0.3, 0.12));
  $outline-color-hover: theming.get-color-from-palette($foreground, divider, if($is-dark-theme, 1, 0.87));
  ...
  $outline-color-disabled: theming.get-color-from-palette($foreground, divider, if($is-dark-theme, 0.15, 0.06));
