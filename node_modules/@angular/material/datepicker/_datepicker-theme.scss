...
@mixin _calendar-color($config, $palette) {
  ...
  $calendar-tokens: tokens-mat-datepicker.private-get-calendar-color-palette-color-tokens($config, $palette);
...
@mixin color($config-or-theme) {
  ...
  .mat-datepicker-toggle-active {
    &.mat-accent {
      $accent-tokens: tokens-mat-datepicker.private-get-toggle-color-palette-color-tokens($config, accent);
      @include token-utils.create-token-values(tokens-mat-datepicker.$prefix, $accent-tokens);
    }

    &.mat-warn {
      $warn-tokens: tokens-mat-datepicker.private-get-toggle-color-palette-color-tokens($config, warn);
