...
class MatLegacySlider extends _MatSliderBase {
  ...
  static {
    this.ɵfac = i0.ɵɵngDeclareFactory({
      ...
      deps: [{token: i0.ElementRef}, {token: i1.FocusMonitor}, {token: i0.ChangeDetectorRef}, {
        ...
        optional: true
      }, {token: 'tabindex', attribute: true}, {token: i0.NgZone}, {token: DOCUMENT}, {
  ...
  static {
    this.ɵcmp = i0.ɵɵngDeclareComponent({
      ...
      outputs: {change: "change", input: "input", valueChange: "valueChange"},
      host: {
        ...
        classAttribute: "mat-slider mat-focus-indicator"
      },
      providers: [MAT_LEGACY_SLIDER_VALUE_ACCESSOR],
      viewQueries: [{propertyName: "_sliderWrapper", first: true, predicate: ["sliderWrapper"], descendants: true}],
      exportAs: ["matSlider"],
...
i0.ɵɵngDeclareClassMetadata({
  minVersion: "12.0.0", version: "16.1.1", ngImport: i0, type: MatLegacySlider, decorators: [{
    type: Component,
    args: [{
      selector: 'mat-slider',
      exportAs: 'matSlider',
...
i0.ɵɵngDeclareClassMetadata({
  minVersion: "12.0.0", version: "16.1.1", ngImport: i0, type: MatLegacySliderModule, decorators: [{
    type: NgModule,
    args: [{
      imports: [CommonModule, MatCommonModule],
      exports: [MatLegacySlider, MatCommonModule],
