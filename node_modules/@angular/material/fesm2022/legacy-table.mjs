...
i0.ɵɵngDeclareClassMetadata({
  minVersion: "12.0.0", version: "16.1.1", ngImport: i0, type: MatLegacyHeaderRowDef, decorators: [{
    type: Directive,
    args: [{
      selector: '[matHeaderRowDef]',
      providers: [{provide: CdkHeaderRowDef, useExisting: MatLegacyHeaderRowDef}],
...
class MatLegacyFooterRowDef extends CdkFooterRowDef {
  ...
  static {
    this.ɵdir = i0.ɵɵngDeclareDirective({
      ...
      inputs: {columns: ["matFooterRowDef", "columns"], sticky: ["matFooterRowDefSticky", "sticky"]},
...
i0.ɵɵngDeclareClassMetadata({
  minVersion: "12.0.0", version: "16.1.1", ngImport: i0, type: MatLegacyFooterRowDef, decorators: [{
    type: Directive,
    args: [{
      selector: '[matFooterRowDef]',
      providers: [{provide: CdkFooterRowDef, useExisting: MatLegacyFooterRowDef}],
...
i0.ɵɵngDeclareClassMetadata({
  minVersion: "12.0.0", version: "16.1.1", ngImport: i0, type: MatLegacyRowDef, decorators: [{
    type: Directive,
    args: [{
      selector: '[matRowDef]',
      providers: [{provide: CdkRowDef, useExisting: MatLegacyRowDef}],
...
class MatLegacyHeaderRow extends CdkHeaderRow {
  ...
  static {
    this.ɵcmp = i0.ɵɵngDeclareComponent({
      ...
      host: {attributes: {"role": "row"}, classAttribute: "mat-header-row"},
...
i0.ɵɵngDeclareClassMetadata({
  minVersion: "12.0.0", version: "16.1.1", ngImport: i0, type: MatLegacyHeaderRow, decorators: [{
    type: Component,
    args: [{
      selector: 'mat-header-row, tr[mat-header-row]',
...
class MatLegacyFooterRow extends CdkFooterRow {
  ...
  static {
    this.ɵcmp = i0.ɵɵngDeclareComponent({
      ...
      host: {attributes: {"role": "row"}, classAttribute: "mat-footer-row"},
...
i0.ɵɵngDeclareClassMetadata({
  minVersion: "12.0.0", version: "16.1.1", ngImport: i0, type: MatLegacyFooterRow, decorators: [{
    type: Component,
    args: [{
      selector: 'mat-footer-row, tr[mat-footer-row]',
      template: CDK_ROW_TEMPLATE,
...
class MatLegacyRow extends CdkRow {
  ...
  static {
    this.ɵcmp = i0.ɵɵngDeclareComponent({
      ...
      host: {attributes: {"role": "row"}, classAttribute: "mat-row"},
...
i0.ɵɵngDeclareClassMetadata({
  minVersion: "12.0.0", version: "16.1.1", ngImport: i0, type: MatLegacyRow, decorators: [{
    type: Component,
    args: [{
      selector: 'mat-row, tr[mat-row]',
      template: CDK_ROW_TEMPLATE,
...
i0.ɵɵngDeclareClassMetadata({
  minVersion: "12.0.0", version: "16.1.1", ngImport: i0, type: MatLegacyNoDataRow, decorators: [{
    type: Directive,
    args: [{
      selector: 'ng-template[matNoDataRow]',
      providers: [{provide: CdkNoDataRow, useExisting: MatLegacyNoDataRow}],
...
class MatLegacyTextColumn extends CdkTextColumn {
  ...
  `,
      ...
      dependencies: [{
        ...
        type: MatLegacyColumnDef,
        selector: "[matColumnDef]",
        inputs: ["sticky", "matColumnDef"]
      }, {kind: "directive", type: MatLegacyCellDef, selector: "[matCellDef]"}, {
        kind: "directive",
        type: MatLegacyHeaderCell,
        selector: "mat-header-cell, th[mat-header-cell]"
      }, {kind: "directive", type: MatLegacyCell, selector: "mat-cell, td[mat-cell]"}],
      changeDetection: i0.ChangeDetectionStrategy.Default,
      encapsulation: i0.ViewEncapsulation.None
    });
  }
...
i0.ɵɵngDeclareClassMetadata({
  minVersion: "12.0.0", version: "16.1.1", ngImport: i0, type: MatLegacyTextColumn, decorators: [{
    type: Component,
    args: [{
      selector: 'mat-text-column',
      template: `
...
class MatLegacyTableModule {
  ...
  static {
    this.ɵmod = i0.ɵɵngDeclareNgModule({
      minVersion: "14.0.0", version: "16.1.1", ngImport: i0, type: MatLegacyTableModule, declarations: [
        // Table
        MatLegacyTable,
        MatLegacyRecycleRows,
        // Template defs
...
i0.ɵɵngDeclareClassMetadata({
  minVersion: "12.0.0", version: "16.1.1", ngImport: i0, type: MatLegacyTableModule, decorators: [{
    type: NgModule,
    args: [{
