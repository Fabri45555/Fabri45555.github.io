...
i0.ɵɵngDeclareClassMetadata({
  minVersion: "12.0.0", version: "16.1.1", ngImport: i0, type: MatLegacyMenu, decorators: [{
    type: Component,
    args: [{
      selector: 'mat-menu',
...
class MatLegacyMenuItem extends MatMenuItem {
  ...
  static {
    this.ɵcmp = i0.ɵɵngDeclareComponent({
      ...
      inputs: {disabled: "disabled", disableRipple: "disableRipple"},
      host: {
        properties: {
          "attr.role": "role",
      ...
      providers: [{provide: MatMenuItem, useExisting: MatLegacyMenuItem}],
...
i0.ɵɵngDeclareClassMetadata({
  minVersion: "12.0.0", version: "16.1.1", ngImport: i0, type: MatLegacyMenuItem, decorators: [{
    type: Component,
    args: [{
      selector: '[mat-menu-item]',
      exportAs: 'matMenuItem',
...
class MatLegacyMenuModule {
  ...
  static {
    this.ɵinj = i0.ɵɵngDeclareInjector({
      ...
      imports: [CommonModule, MatCommonModule, MatRippleModule, OverlayModule, CdkScrollableModule,
        MatCommonModule]
    });
  }
}
...
i0.ɵɵngDeclareClassMetadata({
  minVersion: "12.0.0", version: "16.1.1", ngImport: i0, type: MatLegacyMenuModule, decorators: [{
    type: NgModule,
    args: [{
      imports: [CommonModule, MatCommonModule, MatRippleModule, OverlayModule],
      exports: [
