...
class MatLegacyChipAvatarHarness extends ComponentHarness {
  static {
    this.hostSelector = '.mat-chip-avatar';
  }
...
class MatLegacyChipInputHarness extends ComponentHarness {
  static {
    this.hostSelector = '.mat-chip-input';
  }
...
class MatLegacyChipListHarness extends _MatChipListHarnessBase {
  ...
  static {
    this.hostSelector = '.mat-chip-list';
  }
  ...
  async getInput(filter = {}) {
    ...
    return this.documentRootLocatorFactory().locatorFor(MatLegacyChipInputHarness.with({
      ...filter,
      selector: `#${inputId}`
    }))();
  }
