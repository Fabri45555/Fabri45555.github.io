...
i0.ɵɵngDeclareClassMetadata({
  minVersion: "12.0.0", version: "16.1.1", ngImport: i0, type: MatBottomSheetModule, decorators: [{
    type: NgModule,
    args: [{
      imports: [DialogModule, MatCommonModule, PortalModule],
      exports: [MatBottomSheetContainer, MatCommonModule],
...
class MatBottomSheet {
  ...
  static {
    this.ɵfac = i0.ɵɵngDeclareFactory({
      ...
      ngImport: i0,
      type: MatBottomSheet,
      deps: [{token: i3.Overlay}, {token: i0.Injector}, {
...
i0.ɵɵngDeclareClassMetadata({
  minVersion: "12.0.0", version: "16.1.1", ngImport: i0, type: MatBottomSheet, decorators: [{
    ...
    return [{type: i3.Overlay}, {type: i0.Injector}, {
