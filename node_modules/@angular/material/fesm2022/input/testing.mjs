...
class MatInputHarness extends MatFormFieldControlHarness {
  ...
  static {
    this.hostSelector = '[matInput], input[matNativeControl], textarea[matNativeControl]';
  }
...
class MatNativeOptionHarness extends ComponentHarness {
  ...
  static {
    this.hostSelector = 'select[matNativeControl] option';
  }
...
class MatNativeSelectHarness extends MatFormFieldControlHarness {
  static {
    this.hostSelector = 'select[matNativeControl]';
  }
