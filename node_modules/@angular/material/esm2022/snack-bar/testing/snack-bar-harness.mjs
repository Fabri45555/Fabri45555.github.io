...
export class MatSnackBarHarness extends _MatSnackBarHarnessBase {
  ...
  static {
    this.hostSelector = '.mat-mdc-snack-bar-container:not([mat-exit])';
  }
