...
export class NativeDateAdapter extends DateAdapter {
  ...
  static {
    this.ɵfac = i0.ɵɵngDeclareFactory({
      ...
      deps: [{token: MAT_DATE_LOCALE, optional: true}, {token: i1.Platform}],
