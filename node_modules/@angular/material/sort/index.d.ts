...
export declare class MatSort extends _MatSortBase implements CanDisable, HasInitialized, OnChanges, OnDestroy, OnInit {
  ...
  static ɵdir: i0.ɵɵDirectiveDeclaration<MatSort, "[matSort]", ["matSort"], {
    "disabled": { "alias": "matSortDisabled"; "required": false; };
    "active": { "alias": "matSortActive"; "required": false; };
    "start": { "alias": "matSortStart"; "required": false; };
    "direction": { "alias": "matSortDirection"; "required": false; };
    "disableClear": { "alias": "matSortDisableClear"; "required": false; };
  }, { "sortChange": "matSortChange"; }, never, never, false, never>;
}
...
export declare class MatSortHeader extends _MatSortHeaderBase implements CanDisable, MatSortable, OnDestroy, OnInit, AfterViewInit {
  ...
  static ɵfac: i0.ɵɵFactoryDeclaration<MatSortHeader, [null, null, { optional: true; }, {
    optional: true;
  ...
  static ɵcmp: i0.ɵɵComponentDeclaration<MatSortHeader, "[mat-sort-header]", ["matSortHeader"], {
    ...
    "id": { "alias": "mat-sort-header"; "required": false; };
    "arrowPosition": { "alias": "arrowPosition"; "required": false; };
    "start": { "alias": "start"; "required": false; };
    "sortActionDescription": { "alias": "sortActionDescription"; "required": false; };
    "disableClear": { "alias": "disableClear"; "required": false; };
  }, {}, never, ["*"], false, never>;
}
