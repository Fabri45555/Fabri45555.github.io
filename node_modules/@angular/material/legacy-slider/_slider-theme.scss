...
@mixin color($config-or-theme) {
  ...
  $mat-slider-labeled-min-value-thumb-color: theming.get-color-from-palette($foreground, slider-min);
  $mat-slider-labeled-min-value-thumb-label-color: theming.get-color-from-palette($foreground, slider-off);
  $mat-slider-tick-opacity: 0.7;
  $mat-slider-tick-color: theming.get-color-from-palette($foreground, base, $mat-slider-tick-opacity);
