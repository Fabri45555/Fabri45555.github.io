...
export declare class MatLegacyChip extends _MatChipMixinBase implements FocusableOption, OnDestroy, CanColor, CanDisableRipple, RippleTarget, HasTabIndex, CanDisable {
  ...
  static ɵfac: i0.ɵɵFactoryDeclaration<MatLegacyChip, [null, null, null, { optional: true; }, null, null, {
    optional: true;
  }, { attribute: "tabindex"; }]>;
  static ɵdir: i0.ɵɵDirectiveDeclaration<MatLegacyChip, "mat-basic-chip, [mat-basic-chip], mat-chip, [mat-chip]", ["matChip"], {
    ...
    "destroyed": "destroyed";
    "removed": "removed";
  }, ["avatar", "trailingIcon", "removeIcon"], never, false, never>;
}
...
export declare class MatLegacyChipInput implements MatLegacyChipTextControl, OnChanges, OnDestroy, AfterContentInit {
  ...
  static ɵdir: i0.ɵɵDirectiveDeclaration<MatLegacyChipInput, "input[matChipInputFor]", ["matChipInput", "matChipInputFor"], {
    "chipList": { "alias": "matChipInputFor"; "required": false; };
...
export declare class MatLegacyChipList extends _MatChipListBase implements MatLegacyFormFieldControl<any>, ControlValueAccessor, AfterContentInit, DoCheck, OnInit, OnDestroy, CanUpdateErrorState {
  ...
  static ɵfac: i0.ɵɵFactoryDeclaration<MatLegacyChipList, [null, null, { optional: true; }, { optional: true; }, {
    optional: true;
  }, null, { optional: true; self: true; }]>;
  static ɵcmp: i0.ɵɵComponentDeclaration<MatLegacyChipList, "mat-chip-list", ["matChipList"], {
    "role": { "alias": "role"; "required": false; };
    "userAriaDescribedBy": { "alias": "aria-describedby"; "required": false; };
    ...
    "selectable": { "alias": "selectable"; "required": false; };
    "tabIndex": { "alias": "tabIndex"; "required": false; };
  }, { "change": "change"; "valueChange": "valueChange"; }, ["chips"], ["*"], false, never>;
}
