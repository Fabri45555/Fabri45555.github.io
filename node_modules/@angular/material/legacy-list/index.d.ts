...
export declare class MatLegacyList extends _MatListBase implements CanDisable, CanDisableRipple, OnChanges, OnDestroy {
  ...
  static ɵcmp: i0.ɵɵComponentDeclaration<MatLegacyList, "mat-list, mat-action-list", ["matList"], {
...
export declare class MatLegacyListItem extends _MatListItemMixinBase implements AfterContentInit, CanDisableRipple, OnDestroy {
  ...
  static ɵcmp: i0.ɵɵComponentDeclaration<MatLegacyListItem, "mat-list-item, a[mat-list-item], button[mat-list-item]", ["matListItem"], {
    "disableRipple": { "alias": "disableRipple"; "required": false; };
    "disabled": { "alias": "disabled"; "required": false; };
  }, {}, ["_avatar", "_icon", "_lines"], ["[mat-list-avatar], [mat-list-icon], [matListAvatar], [matListIcon]", "[mat-line], [matLine]", "*"], false, never>;
}
...
export declare class MatLegacyListOption extends _MatListOptionBase implements AfterContentInit, OnDestroy, OnInit, FocusableOption, CanDisableRipple {
  ...
  static ɵcmp: i0.ɵɵComponentDeclaration<MatLegacyListOption, "mat-list-option", ["matListOption"], {
    "disableRipple": { "alias": "disableRipple"; "required": false; };
  ...
  }, ["_avatar", "_icon", "_lines"], ["*", "[mat-list-avatar], [mat-list-icon], [matListAvatar], [matListIcon]"], false, never>;
}
...
export declare class MatLegacyNavList extends _MatListBase implements CanDisable, CanDisableRipple, OnChanges, OnDestroy {
  ...
  static ɵcmp: i0.ɵɵComponentDeclaration<MatLegacyNavList, "mat-nav-list", ["matNavList"], {
    "disableRipple": { "alias": "disableRipple"; "required": false; };
    "disabled": { "alias": "disabled"; "required": false; };
  }, {}, never, ["*"], false, never>;
}
...
export declare class MatLegacySelectionList extends _MatSelectionListBase implements CanDisableRipple, AfterContentInit, ControlValueAccessor, OnDestroy, OnChanges {
  ...
  static ɵcmp: i0.ɵɵComponentDeclaration<MatLegacySelectionList, "mat-selection-list", ["matSelectionList"], {
    "disableRipple": { "alias": "disableRipple"; "required": false; };
    "color": { "alias": "color"; "required": false; };
    "compareWith": { "alias": "compareWith"; "required": false; };
    "disabled": { "alias": "disabled"; "required": false; };
    "multiple": { "alias": "multiple"; "required": false; };
  }, { "selectionChange": "selectionChange"; }, ["options"], ["*"], false, never>;
}
