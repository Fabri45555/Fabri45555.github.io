...
export declare class MatNestedTreeNode<T, K = T> extends CdkNestedTreeNode<T, K> implements AfterContentInit, OnDestroy, OnInit {
  ...
  static ɵdir: i0.ɵɵDirectiveDeclaration<MatNestedTreeNode<any, any>, "mat-nested-tree-node", ["matNestedTreeNode"], {
    ...
    "node": { "alias": "matNestedTreeNode"; "required": false; };
...
export declare class MatTreeNodeDef<T> extends CdkTreeNodeDef<T> {
  ...
  static ɵdir: i0.ɵɵDirectiveDeclaration<MatTreeNodeDef<any>, "[matTreeNodeDef]", never, {
    "when": { "alias": "matTreeNodeDefWhen"; "required": false; };
    "data": { "alias": "matTreeNode"; "required": false; };
  }, {}, never, never, false, never>;
}
...
export declare class MatTreeNodePadding<T, K = T> extends CdkTreeNodePadding<T, K> {
  ...
  static ɵdir: i0.ɵɵDirectiveDeclaration<MatTreeNodePadding<any, any>, "[matTreeNodePadding]", never, {
    "level": { "alias": "matTreeNodePadding"; "required": false; };
    "indent": { "alias": "matTreeNodePaddingIndent"; "required": false; };
  }, {}, never, never, false, never>;
}
...
export declare class MatTreeNodeToggle<T, K = T> extends CdkTreeNodeToggle<T, K> {
  ...
  static ɵdir: i0.ɵɵDirectiveDeclaration<MatTreeNodeToggle<any, any>, "[matTreeNodeToggle]", never, {
    "recursive": { "alias": "matTreeNodeToggleRecursive"; "required": false; };
  }, {}, never, never, false, never>;
}
