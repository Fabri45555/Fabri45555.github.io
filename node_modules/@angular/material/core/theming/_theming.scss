...
@mixin private-check-duplicate-theme-styles($theme-or-color-config, $id) {
  ...
  compatibility.$private-density-generate-at-root:
private-is-legacy-constructed-theme($theme);
  compatibility.$private-density-generate-styles: not
  $duplicate-legacy-density;
