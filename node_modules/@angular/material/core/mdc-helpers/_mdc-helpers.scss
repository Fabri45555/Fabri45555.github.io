...
$mdc-base-styles-without-animation-query: mdc-feature-targeting.all($mdc-base-styles-query, mdc-feature-targeting.without(animation));
...
text-primary-on-background:_variable-safe-ink-color-for-fill(primary, mdc-theme-color . $background, $is-dark),
text-secondary-on-background:_variable-safe-ink-color-for-fill(secondary, mdc-theme-color . $background, $is-dark),
text-hint-on-background:_variable-safe-ink-color-for-fill(hint, mdc-theme-color . $background, $is-dark),
text-disabled-on-background:_variable-safe-ink-color-for-fill(disabled, mdc-theme-color . $background, $is-dark),
text-icon-on-background:_variable-safe-ink-color-for-fill(icon, mdc-theme-color . $background, $is-dark),
...
@mixin using-mdc-typography($config) {
  ...
  typography-config-to-mdc($config);
  }
...
;
  @content;
  mdc-theme-css.$enable-fallback-declarations:
  $previous-value;
}
