...
export declare class MatOptgroup extends _MatOptgroupBase {
  ...
  }, {}, never, ["*", "mat-option, ng-container"], false, never>;
}
...
export declare class _MatOptgroupBase extends _MatOptgroupMixinBase implements CanDisable {
  ...
  static ɵdir: i0.ɵɵDirectiveDeclaration<_MatOptgroupBase, never, never, {
...
export declare class _MatOptionBase<T = any> implements FocusableOption, AfterViewChecked, OnDestroy {
  ...
  static ɵdir: i0.ɵɵDirectiveDeclaration<_MatOptionBase<any>, never, never, {
    "value": { "alias": "value"; "required": false; };
    "id": { "alias": "id"; "required": false; };
    "disabled": { "alias": "disabled"; "required": false; };
  }, { "onSelectionChange": "onSelectionChange"; }, never, never, false, never>;
}
...
export declare class MatPseudoCheckbox {
  ...
  static ɵcmp: i0.ɵɵComponentDeclaration<MatPseudoCheckbox, "mat-pseudo-checkbox", never, {
...
export declare class MatRipple implements OnInit, OnDestroy, RippleTarget {
  ...
  static ɵdir: i0.ɵɵDirectiveDeclaration<MatRipple, "[mat-ripple], [matRipple]", ["matRipple"], {
    "color": { "alias": "matRippleColor"; "required": false; };
    "unbounded": { "alias": "matRippleUnbounded"; "required": false; };
    "centered": { "alias": "matRippleCentered"; "required": false; };
    "radius": { "alias": "matRippleRadius"; "required": false; };
    "animation": { "alias": "matRippleAnimation"; "required": false; };
    "disabled": { "alias": "matRippleDisabled"; "required": false; };
    "trigger": { "alias": "matRippleTrigger"; "required": false; };
  }, {}, never, never, false, never>;
}
