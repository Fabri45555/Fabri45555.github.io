...
export declare class CdkStep implements OnChanges {
  ...
  static ɵcmp: i0.ɵɵComponentDeclaration<CdkStep, "cdk-step", ["cdkStep"], {
    "stepControl": { "alias": "stepControl"; "required": false; };
    ...
    "completed": { "alias": "completed"; "required": false; };
    "hasError": { "alias": "hasError"; "required": false; };
  }, { "interactedStream": "interacted"; }, ["stepLabel"], ["*"], false, never>;
}
...
export declare class CdkStepper implements AfterContentInit, AfterViewInit, OnDestroy {
  ...
  static ɵdir: i0.ɵɵDirectiveDeclaration<CdkStepper, "[cdkStepper]", ["cdkStepper"], {
    "linear": { "alias": "linear"; "required": false; };
  ...
  }, ["_steps", "_stepHeader"], never, false, never>;
}
...
export declare class CdkStepperNext {
  ...
  static ɵdir: i0.ɵɵDirectiveDeclaration<CdkStepperNext, "button[cdkStepperNext]", never, {
...
export declare class CdkStepperPrevious {
  ...
  static ɵdir: i0.ɵɵDirectiveDeclaration<CdkStepperPrevious, "button[cdkStepperPrevious]", never, {
    "type": { "alias": "type"; "required": false; };
  }, {}, never, never, false, never>;
}
