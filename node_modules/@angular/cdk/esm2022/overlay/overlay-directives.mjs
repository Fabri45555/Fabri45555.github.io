...
export class CdkConnectedOverlay {
  ...
  static {
    this.ɵfac = i0.ɵɵngDeclareFactory({
      ...
      deps: [{token: i1.Overlay}, {token: i0.TemplateRef}, {token: i0.ViewContainerRef}, {token: CDK_CONNECTED_OVERLAY_SCROLL_STRATEGY}, {
...
i0.ɵɵngDeclareClassMetadata({
  minVersion: "12.0.0", version: "16.1.1", ngImport: i0, type: CdkConnectedOverlay, decorators: [{
    ...
    return [{type: i1.Overlay}, {type: i0.TemplateRef}, {type: i0.ViewContainerRef}, {
