...
test('Basic true tests', t => {
  ...
  t.is(isPromise(new Promise((resolve, reject) => {
  })), true)
})
...
test('isFunction', t => {
  ...
  t.is(isFunction(function () {
  }), true)
  t.is(isFunction(async () => {
  }), true)
  t.is(isFunction(async function () {
  }), true)
  t.is(isFunction(function* () {
  }), true)
  t.is(isFunction(async function* () {
...
test('NaN tests', t => {
  ...
  t.is(isNaNValue(new Promise((resolve, reject) => {
  })), false)
})
