...
function internalize(u, D, e) {
  ...
  if (null != r && "object" == typeof r) if (Array.isArray(r)) for (let u = 0; u < r.length; u++) {
    ...
    void 0 === t ? delete r[D] : Object.defineProperty(r, D, {value: t, writable: !0, enumerable: !0, configurable: !0})
  } else for (const u in r) {
    const D = internalize(r, u, e);
    void 0 === D ? delete r[u] : Object.defineProperty(r, u, {value: D, writable: !0, enumerable: !0, configurable: !0})
  }
  return e.call(u, D, r)
}
